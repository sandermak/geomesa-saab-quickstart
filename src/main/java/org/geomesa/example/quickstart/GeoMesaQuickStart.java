...
import org.geomesa.example.data.SaabTrackData;
...
public class GeoMesaQuickStart implements Runnable {
    ...
    private final SaabTrackData data;
    private final boolean cleanup;
    private final boolean readOnly;

    // uses saab data
    public GeoMesaQuickStart(String[] args)  throws ParseException {
        this(args, new AccumuloDataStoreFactory().getParametersInfo(), new SaabTrackData());
    }
    ...
    public GeoMesaQuickStart(String[] args, Param[] parameters, SaabTrackData data) throws ParseException {
        this(args, parameters, data, false);
    }

    public GeoMesaQuickStart(String[] args, Param[] parameters, SaabTrackData data, boolean readOnly) throws ParseException {
    ...
    public void ensureSchema(DataStore datastore, SaabTrackData data) throws IOException {
    ...
    public SimpleFeatureType getSimpleFeatureType(SaabTrackData data) {
    ...
    public List<SimpleFeature> getTestFeatures(SaabTrackData data) {
    ...
    public List<Query> getTestQueries(SaabTrackData data) {
